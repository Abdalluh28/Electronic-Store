...
const sendVerificationEmailRegister = async (newUser, accessToken) => {
    ...
    const mailOptions = {
        ...
        text: `Please verify your email by clicking the following link: ${process.env.CLIENT_URL}/auth/verify/${newUser._id}/${accessToken}`
    };
...
const sendVerificationEmailLogin = asyncHandler(async (req, res) => {
    ...
    const mailOptions = {
        ...
        subject: 'Verify your email',
        text: `Please verify your email by clicking the following link: ${process.env.CLIENT_URL}/auth/verify/${existingUser._id}/${accessToken}`
    };
